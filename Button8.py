...
img = (Image.open(r"Images/book_files/9.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Fantasy, Romance, Paranormal \nLanguage: English \nRating: M")
...
#Title of Book
title_1 = Label(win, text='The Cruel Prince', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
...
text_2 = Label(win, text="Jude was seven when her parents were murdered and \nshe and her two sisters were stolen away to live in the \ntreacherous High Court of Faerie. Ten years later, Jude \nwants nothing more than to belong there, despite her \nmortality. But many of the fey despise humans. \nEspecially Prince Cardan, the youngest and wickedest \nson of the High King. To win a place at the Court, \nshe must defy him–and face the consequences. \nAs Jude becomes more deeply embroiled in palace \nintrigues and deceptions, she discovers her own \ncapacity for trickery and bloodshed. But as betrayal \nthreatens to drown the Courts of Faerie in violence, \nJude will need to risk her life in a dangerous alliance \nto save her sisters, and Faerie itself. ", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("8_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("8_reviews.txt") as file:
   for line in file:
