...
img = (Image.open(r"Images/book_files/5.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Fantasy, Adventure, Fiction \nLanguage: English \nRating: T")
...
#Title of Book
title_1 = Label(win, text='The Red Pyramid', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
title_1.place(x=650, y=50)

#Author
label_1 = Label(win, text='Author:', font=('arial', 10, 'bold'), bg='#FCEFD3')
label_1.place(x=580,y=100)

text_1 = Label(win, text="Rick Riordan", font=('arial', 10), bg='#FCEFD3')
...
text_2 = Label(win, text="'I GUESS IT STARTED THE NIGHT OUR DAD BLEW \nUP THE BRITISH MUSEUM . . .' CARTER AND SADIE \nKANE'S dad is a brilliant Egyptologist with a secret \nplan that goes horribly wrong. An explosion shatters \nthe ancient Rosetta stone and unleashes Set, the evil \ngod of chaos . . . Set imprisons Dr Kane in a golden \ncoffin and Carter and Sadie must run for their lives. To \nsave their dad, they embark on a terrifying quest from \nCairo to Paris to the American South-west and \ndiscover the truth about their family's connection to the \nHouse of Life: an Egyptian temple of magic that has \nexisted for thousands of years. The pharaohs of \nancient Egypt are far from dead and buried. And so, \nunfortunately, are their gods . . . ", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("4_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("4_reviews.txt") as file:
   for line in file:
