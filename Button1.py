...
img = (Image.open(r"Images/book_files/2.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Nonfiction, Autobiography, Historical \nLanguage: English \nRating: G")
...
#Title of Book
title_1 = Label(win, text='Chinese Cinderella', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
title_1.place(x=635, y=50)

#Author
label_1 = Label(win, text='Author:', font=('arial', 10, 'bold'), bg='#FCEFD3')
label_1.place(x=580,y=100)

text_1 = Label(win, text="Adeline Yen Mah", font=('arial', 10), bg='#FCEFD3')
...
text_2 = Label(win, text="A riveting memoir of a girl's painful coming-of-age in a \nwealthy Chinese family during the 1940s. A Chinese \nproverb says, 'Falling leaves return to their roots.' In \nChinese Cinderella, Adeline Yen Mah returns to her \nroots to tell the story of her painful childhood and her \nultimate triumph and courage in the face of despair. \nAdeline's affluent, powerful family considers her \nbad luck after her mother dies giving birth to her. Life \ndoes not get any easier when her father remarries. She \nand her siblings are subjected to the disdain of her \nstepmother, while her stepbrother and stepsister are \nspoiled. Although Adeline wins prizes at school, they \nare not enough to compensate for what she really \nyearns for -- the love and understanding of her family. \nFollowing the success of the critically acclaimed adult \nbestseller Falling Leaves, this memoir is a moving \ntelling of the classic Cinderella story, with Adeline \nYen Mah providing her own courageous voice.", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("1_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("1_reviews.txt") as file:
   for line in file:
