...
img = (Image.open(r"Images/book_files/11.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Fantasy, Fiction, Romance, Paranormal \nLanguage: English \nRating: M")
...
#Title of Book
title_1 = Label(win, text='The Queen of Nothing', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
title_1.place(x=620, y=50)
...
text_2 = Label(win, text="Power is much easier to acquire than it is to hold \nonto. Jude learned this lesson when she released her \ncontrol over the wicked king, Cardan, in exchange for \nimmeasurable power. Now as the exiled mortal \nQueen of Faerie, Jude is powerless and left reeling \nfrom Cardan’s betrayal. She bides her time determined \nto reclaim everything he took from her. Opportunity \narrives in the form of her deceptive twin sister, Taryn, \nwhose mortal life is in peril. Jude must risk venturing \nback into the treacherous Faerie Court, and confront \nher lingering feelings for Cardan, if she wishes to save \nher sister. But Elfhame is not as she left it. \nWar is brewing. As Jude slips deep within enemy lines \nshe becomes ensnared in the conflict’s bloody politics. \nAnd, when a dormant yet powerful curse is unleashed, \npanic spreads throughout the land, forcing her \nto choose between her \nambition and her humanity… ", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("10_ratings.txt") as file:
   for line in file:
