...
img = (Image.open(r"Images/book_files/8.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Classics, Mystery, Literature, Thriller \nLanguage: English \nRating: M")
...
#Title of Book
title_1 = Label(win, text='The Complete Sherlock Holmes', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
title_1.place(x=520, y=50)

#Author
label_1 = Label(win, text='Author:', font=('arial', 10, 'bold'), bg='#FCEFD3')
label_1.place(x=580,y=100)

text_1 = Label(win, text="Sir Arthur Conan Doyle", font=('arial', 10), bg='#FCEFD3')
...
text_2 = Label(win, text="A master of deductive reasoning who can solve \nthe most difficult crimes by spotting obscure clues \noverlooked by others, dilettante sleuth Sherlock \nHolmes was the hero of sixty stories written by Sir \nArthur Conan Doyle between 1887 and 1927. He \neven rose from the dead after Doyle tried to dispatch \nhim in his twenty-fourth adventure, and readers \nprotested. Here, in one volume, are all four full-length \nnovels and fifty-six short stories about the colourful \nadventures of Sherlock Holmes ― every word Sir \nArthur Conan Doyle ever wrote about Baker Street's \nmost famous resident.", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("7_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("7_reviews.txt") as file:
   for line in file:
