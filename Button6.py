...
img = (Image.open(r"Images/book_files/7.png"))
...
#Title of Book
title_1 = Label(win, text='Little Women', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
...
text_1 = Label(win, text="Louisa May Alcott", font=('arial', 10), bg='#FCEFD3')
...
text_2 = Label(win, text="Generations of readers young and old, male\n and female, have fallen in love with the March \nsisters of Louisa May Alcott’s most popular and \nenduring novel, Little Women. Here are talented \ntomboy and author-to-be Jo, tragically frail Beth, \nbeautiful Meg, and romantic, spoiled Amy, \nunited in their devotion to each other and their \nstruggles to survive in New England \nduring the Civil War. Since 1868, readers have rooted \nfor Laurie in his pursuit of Jo's hand, cried over the \nfamily's tragedy, and dreamed of traveling through \nEurope with old Aunt March and Amy. In this simple, \nenthralling tale, Lousia May Alcott has create four of \nAmerican literature's most beloved women", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("6_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("6_reviews.txt") as file:
   for line in file:
