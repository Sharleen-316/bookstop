...
img = (Image.open(r"Images/book_files/10.png"))
...
def message():
  messagebox.showinfo("Content Tags/Ratings/Language", "Content Tags: Romance, Fantasy, Fiction \nLanguage: English \nRating: M")
...
#Title of Book
title_1 = Label(win, text='The Wicked King', font=('lucida bright', 20, 'bold'), bg='#B89B79', fg='#584A38')
...
text_1 = Label(win, text="Holly Black", font=('arial', 10), bg='#FCEFD3')
...
text_2 = Label(win, text="After the jaw-dropping revelation that Oak is the heir to \nFaerie, Jude must keep her brother safe. To do so, \nshe has bound the wicked king, Cardan, to her, and \nmade herself the power behind the throne. Navigating \nthe constantly shifting political alliances of Faerie \nwould be difficult enough if Cardan were easy to \ncontrol. But he does everything in his power to \nhumiliate and undermine her even as his fascination \nwith her remains undiminished. When it becomes all \ntoo clear that someone close to Jude means to betray \nher, threatening her own life and the lives of everyone \nshe loves, Jude must uncover the traitor and fight her \nown complicated feelings for Cardan to maintain \ncontrol as a mortal in a Faerie world.", font=('arial', 10), bg='#FCEFD3')
...
rating = []
with open("9_ratings.txt") as file:
   for line in file:
...
reviews = []
with open("9_reviews.txt") as file:
   for line in file:
